	...
	<body>
        ...
        <div id="size" class="panel panel-success">
          ...
          <div class="panel-body">
            Interaction Log recorded successfully!
          </div>
        </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Interaction Log</h4>
              </div>
              <div class="modal-body">
                <?php
                  $data = mysql_query('Select date, ilCName, ilContact, ilPeople, ilLocation from interactionlog ORDER BY ilID desc limit 1')
                  or die(mysql_error()); 
                  $info = mysql_fetch_array( $data ); 
                  Print "<b>Date:</b> ".$info['date'] . " <br>"; 
                  Print "<b>Company Name:</b> ".$info['ilCName'] . " <br>"; 
                  Print "<b>Contact Person:</b> ".$info['ilContact'] . " <br>"; 
                  Print "<b>People present during the meeting:</b> ".$info['ilPeople'] . " <br>"; 
                  Print "<b>Location:</b> ".$info['ilLocation'] . " <br>"; 
                ?>
              </div>
