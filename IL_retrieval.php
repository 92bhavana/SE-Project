	...
	<body>
		<div class="container-fluid">
			<div class="container">
				...
				<br>
   	 			<?php
    				$fetch_record_query = "SELECT * from interactionlog"; 
					$fetch_record = mysql_query($fetch_record_query);
					
					while($record_data = mysql_fetch_array($fetch_record))
					{
						$date = $record_data["date"];
						$ilcname = $record_data["ilCName"];
						$ilcontact = $record_data["ilContact"];
						$ilPeople = $record_data["ilPeople"];
						$ilLocation = $record_data["ilLocation"];

						echo'<div class="panel panel-primary">';
  						echo'<div class="panel-heading">'.$ilcname. ' ['.$date.']</div>';
  						echo'<div class="panel-body">';
						
						print "<br>";
						print "Contact Person: ".$ilcontact;
						print "<br>";
						print "People present during the meeting: ".$ilPeople;
						print "<br>";
						print "Location: ".$ilLocation;
						echo"</div>";
						echo"</div>";
					}
				?>	
